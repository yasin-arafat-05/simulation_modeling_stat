...
def create_slider_row(label, slider_id, min_val, max_val, step, value, marks_step=60):
    return html.Div([
            html.Label(f'{label}:', style={'color': 'silver', 'width': '100px', 'fontWeight': 'bold'}),
            html.Div(
                dcc.Slider(
                    id=slider_id,
                    min=min_val,
                    ...
                    step=step,
                    value=value,
                    marks={i: {'label': str(i), 'style': {'color': 'gold'}} for i in range(min_val, max_val+1, marks_step)},
                    tooltip={'placement': 'bottom','always_visible': True,'style':{'color':'gold'}}
                ), style={'flex-grow': '1'} 
            )
        ], style={
            'display': 'flex', 
...
app.layout = html.Div([
    ...
    # === 2.1. uniform: ===
    html.Div([
        html.H2("Uniform Distribution",style={'color':'gold','text-align':'center'}),
        html.Div([
    ...
    # === 2.2.Exponential ===
    html.Div([
        html.H2("Exponential Distribution",style={'color':'gold','text-align':'center'}),
        html.Div([
            dcc.Markdown("""**Scale Parameter Beta where, Beta>0**""",style={"color":"silver"}),
    ...
    # === 2.3 Gamma ===
    html.Div([
        html.H2("Gamma Distribution",style={'color':'gold','text-align':'center'}),
        html.Div([
            dcc.Markdown("""**Shape Parameter Alpha(α) where, α>0 and Scale Parameter Beta(β) where, β>0**. If not then alpha+=1 also beta+=1 """,style={"color":"silver"}),
    ...
    # === 2.4 Weibull ===
    html.Div([
        html.H2("Weibull Distribution",style={'color':'gold','text-align':'center'}),
        html.Div([
    ...
    # === 2.5 Normal ===
    html.Div([
        html.H2("Normal", style={'color':'gold','text-align':'center'}),
        html.Div([
    ...
    # === 2.6 LogNormal ===
    html.Div([
        html.H2("LogNormal Distribution",style={'color':'gold','text-align':'center'}),
        html.Div([
    ...
    # === 2.7 Beta ===
    html.Div([
        html.H2("Beta Distribution",style={'color':'gold','text-align':'center'}),
        html.Div([
    ...
    # === 2.8 Pearson ===
    html.Div([
        html.H2("Pearson-V Distribution",style={'color':'gold','text-align':'center'}),
        html.Div([
            dcc.Markdown("""**Shape Parameter Alpha(α) where, α>0 and Scale Parameter Beta(β) where, β>0**. If not then alpha+=1 also beta+=1 """,
                        style={"color":"silver"}),
    ...
    # === 2.9 Log-logistics ===
    html.Div([
        html.H2("Log-Logistics",style={'color':'gold','text-align':'center'}),
        html.Div([
            dcc.Markdown("""**Shape Parameter Alpha(α) where, α>0 and Scale Parameter Beta(β) where, β>0**. If not then alpha+=1 also beta+=1 """,
                        style={"color":"silver"}),
    ...
    # === 2.10 Johnson S_B ===
    html.Div([
        html.H2("Johnson Sb",style={'color':'gold','text-align':'center'}),
        html.Div([
    ...
    html.Div([
        html.H2("Bernoulli Distribution",style={'color':'gold','text-align':'center'}),
        html.Div([
    ...
    html.Div([
        html.H2("Binomial Distribution",style={'color':'gold','text-align':'center'}),
        html.Div([
    ...
    html.Div([
        html.H2("Descreate Uniform Distribution",style={'color':'gold','text-align':'center'}),
        html.Div([
            dcc.Markdown("""**Location Parameter, a(-inf,inf), Scale Parameter (b-a), Shape Parameter α1(-inf,inf) and α2> 0. And a<x<b**""",
                        style={"color":"silver"}),
    ...
    html.Div([
        html.H2("Poisson Distribution",style={'color':'gold','text-align':'center'}),
        html.Div([
            dcc.Markdown("""**Location Parameter, a(-inf,inf), Scale Parameter (b-a), Shape Parameter α1(-inf,inf) and α2> 0. And a<x<b**""",
                        style={"color":"silver"}),
            dcc.Markdown("""- Where number of trials(n) is high.""",style={"color":"silver"}),
            dcc.Markdown("""- Where probability(p) of success is very very low.""",style={"color":"silver"}),
            dcc.Markdown("""- Where mean or lamda(λ) = n * p .""",style={"color":"silver"}),
